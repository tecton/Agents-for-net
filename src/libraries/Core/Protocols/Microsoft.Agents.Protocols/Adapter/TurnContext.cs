...
namespace Microsoft.Agents.Protocols.Adapter
{
    ...
    public class TurnContext : ITurnContext, IDisposable
    {
        ...
        /// <param name="connectorClient">The IConnectorClient for this turn.</param>
        ...
        public TurnContext(IBotAdapter adapter, IActivity activity)
        {
        ...
        /// <exception cref="Microsoft.Agents.Protocols.Connector.ErrorResponseException">
