...
This is a sample of a simple Copilot hosted on an Asp.net core web service, That represents the entry point of a multiBot configuration.  This Copilot is configured to accept a request and echo the text of the request back to the caller or relay them to Bot2.

This Copilot Sample is intended to introduce you the basic operation of the Copilot SDK's messaging loop and how it can communicate with another Copilot SDK bot.
